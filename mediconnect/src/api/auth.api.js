...
/**
 * ResetPasswordRequest : { email, telephone, code, newPassword, confirmPassword }
 * code = OTP à 6 chiffres envoyé par email/SMS via forgotPassword
 */
export const resetPassword = async ({ email, telephone, code, newPassword, confirmPassword }) => {
